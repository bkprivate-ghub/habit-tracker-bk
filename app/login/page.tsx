      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-black/60 backdrop-blur-xl rounded-2xl p-6 border border-white/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full p-3 bg-black/50 border border-white/5 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400/50 text-white placeholder:text-white/20 text-sm"
            ...
            <div>
              <label className="block text-xs text-white/30 mb-1">Password</label>
              <input
                type="password"
                value={password}
          ...
          <button
            ...
            className="w-full py-3 bg-white/5 hover:bg-white/10 border border-white/5 text-white/70 hover:text-white rounded-xl font-medium transition-all flex items-center justify-center gap-2"
          >
